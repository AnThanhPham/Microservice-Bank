...
import com.atp.accounts.service.IAccountsService;
...
@Tag(
        name = "CRUD REST APIs for Accounts in ATPBank",
        description = "CRUD REST APIs in ATPBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside ATPBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
